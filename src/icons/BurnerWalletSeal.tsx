  ...
  return (
    ...
    >
      <g filter="url(#filter0_d_57_17088)">
        ...
        />
        <path className={pathClass} d="M73.1059 63.9263L67.0195 64.9407" />
        <path className={pathClass} d="M67.023 67.9834L73.1094 68.9978" />
        <path className={pathClass} d="M40.6441 63.9263L46.7305 64.9407" />
        <path className={pathClass} d="M46.7309 67.9844L40.6445 68.9988" />
      </g>
      <defs>
        <filter
