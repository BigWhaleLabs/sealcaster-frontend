...
export default function ({ connected }: { connected?: boolean }) {
  const pathColor = stroke(
    connected ? 'stroke-secondary' : 'stroke-primary-semi-dimmed'
  )
  ...
  return connected ? (
    ...
    >
      ...
      />
      <path className={pathColor} d="M16.1937 11.6743L13.8711 12.0614" />
      <path className={pathColor} d="M13.8708 13.8227L16.1934 14.2098" />
      <path className={pathColor} d="M3.80633 11.6743L6.12891 12.0614" />
      <path className={pathColor} d="M6.12922 13.8227L3.80664 14.2098" />
    </svg>
  ) : (
    <svg
      className={svgStyles}
