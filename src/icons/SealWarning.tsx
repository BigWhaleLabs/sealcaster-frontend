...
export default function () {
  return (
    ...
    >
      <circle className={circleClasses} cx="32.5" cy="32" r="31" />
      <path
      ...
      />
      <path className={pathClasses} d="M48.5 37L42.5 38" />
      <path className={pathClasses} d="M42.5 41L48.5 42" />
      <path className={pathClasses} d="M16.5 37L22.5 38" />
      <path className={pathClasses} d="M22.5 41L16.5 42" />
    </svg>
  )
}
