...
const strokeSecondary = stroke('stroke-secondary-dimmed')
...
export default function () {
  return (
    ...
    >
      ...
      />
      <path
        d="M56.1059 47.9282L50.0195 48.9426"
        className={strokeTertiary}
        stroke-width="2"
        stroke-linecap="round"
      />
      <path
        d="M50.023 51.9849L56.1094 52.9993"
        className={strokeTertiary}
        stroke-width="2"
        stroke-linecap="round"
      />
      <path
        d="M23.6441 47.9282L29.7305 48.9426"
        className={strokeTertiary}
        stroke-width="2"
        stroke-linecap="round"
      />
      <path
        d="M29.7309 51.9868L23.6445 53.0012"
        className={strokeTertiary}
        stroke-width="2"
        stroke-linecap="round"
      />
