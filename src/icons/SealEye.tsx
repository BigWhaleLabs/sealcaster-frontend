  ...
  if (upsideDown)
    return (
      ...
      >
        ...
        />
        <path d="M16.1756 11.3008L20.4551 10.5875" className={strokeTertiary} />
        <path d="M20.4533 8.44922L16.1738 7.73598" className={strokeTertiary} />
        <path d="M39.0002 11.3008L34.7207 10.5875" className={strokeTertiary} />
        <path d="M34.7205 8.44727L39 7.73402" className={strokeTertiary} />
        <path
  ...
  return (
    ...
    >
      <path
        ...
        className={strokeTertiary}
      />
      <path d="M38.8244 34.6992L34.5449 35.4125" className={strokeTertiary} />
      <path d="M34.5467 37.5508L38.8262 38.264" className={strokeTertiary} />
      <path d="M15.9998 34.6992L20.2793 35.4125" className={strokeTertiary} />
      <path d="M20.2795 37.5527L16 38.266" className={strokeTertiary} />
      <path
      ...
      <path
        ...
        className={strokeTertiary}
      />
      <circle cx="27.5" cy="21.5" r="2.5" className={strokeTertiary} />
    </svg>
  )
}
