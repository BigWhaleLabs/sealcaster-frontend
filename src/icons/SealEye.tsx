...
const strokeAccent = classnames(commonStrokeWidth, stroke('stroke-accent'))
const strokeSecondary = classnames(
  commonStrokeWidth,
  stroke('stroke-secondary-dimmed')
)
const strokeTertiary = classnames(commonStrokeWidth, stroke('stroke-tertiary'))

export default function ({ upsideDown }: { upsideDown?: boolean }) {
  if (upsideDown)
    return (
      <svg
        height="46"
      ...
      >
        ...
        />
        <path className={strokeTertiary} d="M16.1756 11.3008L20.4551 10.5875" />
        <path className={strokeTertiary} d="M20.4533 8.44922L16.1738 7.73598" />
        <path className={strokeTertiary} d="M39.0002 11.3008L34.7207 10.5875" />
        <path className={strokeTertiary} d="M34.7205 8.44727L39 7.73402" />
        <path
  ...
  return (
    ...
    >
      ...
      />
      <path className={strokeTertiary} d="M38.8244 34.6992L34.5449 35.4125" />
      <path className={strokeTertiary} d="M34.5467 37.5508L38.8262 38.264" />
      <path className={strokeTertiary} d="M15.9998 34.6992L20.2793 35.4125" />
      <path className={strokeTertiary} d="M20.2795 37.5527L16 38.266" />
      <path
        className={strokeSecondary}
      ...
      />
      <circle className={strokeTertiary} cx="27.5" cy="21.5" r="2.5" />
    </svg>
  )
}
